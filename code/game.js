...
var wobbSpeed = 3, wobbDist = 0.4;
Energy.prototype.act = function(step){
  this.wobble +=step * wobbSpeed;
  var wobbPos = Math.sin(this.wobble) * wobbDist;
  var wobbPosY = Math.cos(this.wobble) * wobbDist;
  this.pos = this.basePos.plus(new Vector(wobbPos, wobbPosY));
}
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if(type == "portal"){
    this.player.pos = new Vector (50,10);
  }
};
